...
interface SupplementaryPointsOptions {
  coincidentData?: Array<{ adjacentPoints: any[] }>;
  midpoints?: boolean;
  map?: any;
  selectedPaths?: string[];
}

function createSupplementaryPoints(geojson, options: SupplementaryPointsOptions = {}, basePath = null) {
